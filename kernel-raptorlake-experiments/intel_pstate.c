...
static void intel_pstate_get_cpu_pstates(struct cpudata *cpu)
{
	...
	/* Cache 32‑bit fixed‑point reciprocal for fast division */
	cpu->pstate.scaling_recip =
	div64_u64((1ULL << 32), cpu->pstate.scaling);

	/* Leave the CPU at minimum after probing */
