...
#ifndef IXGBE_EITR_LLI_EN
#define IXGBE_EITR_LLI_EN 0x00000800 /* EITR[11] – LLI enable, X540 spec */
#endif

#ifndef IXGBE_DCA_RXCTRL_ENABLE
#define IXGBE_DCA_RXCTRL_ENABLE 0x00000100 /* DCA_RXCTRL[8] – global enable */
#endif

#ifndef IXGBE_TXDCTL_WTHRESH_MASK
#define IXGBE_TXDCTL_WTHRESH_MASK (0x1F << 16)
...
#define IXGBE_LLITHRESH(n) (0x0EC90 + ((n) * 4))
