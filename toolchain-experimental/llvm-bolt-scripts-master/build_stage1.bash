...
if [ ! -d "${TOPLEV}/llvm-project" ]; then
    echo "Error: ${TOPLEV}/llvm-project not found!"
    echo "Please run setup_llvm_repo.bash first"
    exit 1
fi
...
cmake -G Ninja "${TOPLEV}/llvm-project/llvm" \
    ...
    -DCMAKE_INSTALL_PREFIX="${TOPLEV}/llvm-bolt" > cmake_log.txt 2>&1

if [ $? -ne 0 ]; then
    echo "Could not configure project!"
    echo "Last 50 lines of cmake_log.txt:"
    tail -50 cmake_log.txt
    exit 1
fi
