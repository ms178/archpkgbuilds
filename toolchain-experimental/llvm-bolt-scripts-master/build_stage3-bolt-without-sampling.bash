...
${BOLTPATH}/llvm-bolt \
    ...
    --instrumentation-file=${TOPLEV}/stage3-without-sampling/instrumentdata/clang-18.fdata \
    ${CPATH}/clang-18 \
...
${BOLTPATH}/llvm-bolt \
    ...
    --instrument \
    --instrumentation-file-append-pid \
    --instrumentation-file=${TOPLEV}/stage3-without-sampling/instrumentdata/lld-18.fdata \
    ${CPATH}/lld \
    -o ${CPATH}/lld.inst
